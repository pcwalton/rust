...
import syntax::ast::{stmt_decl, ty, ty_bool, ty_char, ty_constr, ty_f};
import syntax::ast::{ty_f32, ty_f64, ty_float, ty_i, ty_i16, ty_i32, ty_i64};
import syntax::ast::{ty_i8, ty_int, ty_param, ty_path, ty_str, ty_u, ty_u16};
import syntax::ast::{ty_u32, ty_u64, ty_u8, ty_uint, variant, view_item};
